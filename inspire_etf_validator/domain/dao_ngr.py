...
from inspire_etf_validator.constants import URL_NGR, NAMESPACE_PREFIXES, CACHE_FILENAME, CACHE_EXPIRATION_IN_SECONDS, \
    REQUEST_HEADERS
...
def __get_all_ngr_records():
    ...
    start_position = "1"
    while True:
        records_base_url = URL_NGR + "/srv/dut/csw-inspire?request=GetRecords&Service=CSW&Version=2.0.2&typeNames" \
...
def __get_record_info(uuid):
    ...
    record_info_base_url = URL_NGR + "/srv/dut/csw?service=CSW&request=GetRecordById&version=2.0.2&outputSchema=http" \
